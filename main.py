...
<body>
  <div>
    ...
    <footer class="footer">
      ...
      <p><span class="boxed-text"><span class="color-sp">FOLLOW ME ON</span> <a href="https://www.instagram.com/______error_04?igsh=MWFnZTlteGxsZGc3dQ==" class="color-s">INSTAGRAM</a></p>
    </footer>
    </div>
</div>
